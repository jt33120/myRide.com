export default async function handler(req, res) {
  ...
  try {
    const prompt = `
      ...
      Consider factors such as depreciation, market trends, and mileage, and current data online to provide the most accurate estimated value for this vehicle, in US number format. You're answer should be:  "AI-powered valuation : $..."
    `;
