...
export default async function handler(req, res) {
  ...
  try {
    ...
    1. Select the category that is the closest superior to ${currentMileage} (compare column 'NextTimeToDo' with ${currentMileage}). Like this: "Most urgent to come: [Category] at [value in 'NextTimeToDo'] miles (obviously, > ${currentMileage})  "
